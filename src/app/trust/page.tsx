...
const sections = [
    {
        ...
        body: [
            "Proofolio was built in an era when AI tools are a normal part of how people work. We do not pretend otherwise, and we do not expect candidates to pretend otherwise either.",
    ...
    },
    {
        ...
        title: "Proofolio is evidence, not a verdict",
        body: [
            ...
            "We ask employers to use Proofolio as structured evidence that improves hiring conversations, not as a filter that removes humans from the process.",
        ],
    ...
    },
    {
        ...
        body: [
            "Everything a candidate submits on Proofolio — their challenge responses, process documentation, written explanations, skill evidence — belongs to them. We store it, but we do not own it.",
            ...
            "If a candidate leaves Proofolio, their data should leave with them. Export and deletion tooling is part of our roadmap, not an afterthought.",
        ],
    ...
    },
    {
        ...
        body: [
            "Proofolio earns revenue by charging employers and organisations for access to the platform — not by selling candidate information to third parties. That model matters. It means our incentives are aligned with candidates building genuine proof, not with harvesting attention or personal data.",
    ...
    },
    {
        ...
        body: [
            "A 'Verified by Proofolio' marker means that the submission was completed on our platform, the candidate documented their process, and AI usage was disclosed according to our guidelines. It does not mean Proofolio has validated every technical decision the candidate made, or that the candidate will be a guaranteed hire.",
    ...
    },
    {
        ...
        body: [
            "Proofolio sits at the intersection of someone's livelihood and an employer's trust. That is not a neutral position. The decisions we make about scoring, disclosure, visibility, and data affect real people's careers.",
        ...
        <div className="min-h-screen bg-[#0b0f1a] text-white">
            ...
            <section className="max-w-3xl mx-auto px-6 pt-16 pb-12">
                ...
                <p className="text-lg text-slate-400 leading-relaxed mb-4">
                    Proofolio exists to make hiring fairer by replacing vague credentials with verifiable work.
