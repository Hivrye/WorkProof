        ...
        <div className="min-h-screen bg-[#0b0f1a] flex flex-col items-center justify-start px-4 py-12">
            ...
            <div className="w-full max-w-2xl flex items-center justify-between mb-10">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-bold text-lg tracking-tight">Proofolio</span>
                </div>
                <button
                    onClick={handleSkip}
                    disabled={saving}
    ...
    return (
        <div>
            <StepHeading
                ...
                sub="Be honest — Proofolio is designed to work at every stage."
            />
    ...
    return (
        <div>
            <StepHeading
                ...
                sub="Proofolio tracks AI usage on every challenge. You decide what employers see."
            />
    ...
    return (
        <div>
            <StepHeading
                ...
                sub="This is what employers see when they find your Proofolio profile."
            />
