...
> = {
    "strong-yes": {
        ...
        rationale:
            "Alex demonstrates exceptional work quality, self-awareness, and transparency for their experience level. The accessibility challenge score (92/100) is in the top 15% of Proofolio submissions. Recommend proceeding to a technical interview with high confidence.",
    },
    "yes": {
        label: "Yes",
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-white mb-2">
                                    Proofolio does not replace interviews.
                                </h3>
                                <p className="text-sm text-slate-300 leading-relaxed">
                                    ...
                                    Proofolio is designed to surface relevant signal, not to make the hiring decision for you. Use this profile to ask sharper questions, not to skip the conversation.
                                </p>
                                <ul className="mt-3 space-y-1.5">
                                    {[
                                        ...
                                        "Proofolio does not store biometric, demographic, or background data",
                                    ].map((point, i) => (
                ...
                <div className="space-y-6">
                    ...
                    <div className="rounded-xl border border-[#1e2d45] bg-[#111827] p-5">
                        ...
                        <div className="space-y-3 text-sm">
                            ...
                            <div className="flex justify-between">
                                <span className="text-slate-400">On Proofolio since</span>
