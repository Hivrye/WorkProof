        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    description:
                        "Add a verified WorkProof badge and summary to your LinkedIn profile, letting employers find proof evidence without leaving a platform they already use.",
                    tag: "Integrations",
                },
            ],
        },
        ...
        <div className="min-h-screen bg-[#0b0f1a] text-white">
            ...
            <section className="max-w-3xl mx-auto px-6 pt-16 pb-12 text-center">
                ...
                <p className="text-lg text-slate-400 leading-relaxed max-w-2xl mx-auto">
                    WorkProof is early. This roadmap is a transparent look at where we are, what&apos;s
