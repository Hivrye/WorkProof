...
const plans = [
    ...
    },
    {
        ...
        cta: "Talk to us",
        ctaHref: "mailto:hello@proofolio.io",
...
const faqs = [
    ...
    },
    {
        ...
        a: "Yes — email us at hello@proofolio.io. We don't want cost to be the reason someone can't build proof of their skills. We'll work something out.",
    },
    {
    ...
    },
    {
        ...
        a: "Because how you use AI is a real skill. Proofolio doesn't penalize AI use — it requires transparent disclosure. Employers are increasingly interested in candidates who can collaborate with AI effectively and explain what they personally contributed. Honest disclosure is scored positively.",
    },
    {
                ...
                <div className="mt-10 rounded-xl border border-[#1e2d45] bg-[#0d1424] p-6 flex items-start gap-4 max-w-3xl mx-auto">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-400 leading-relaxed">
                            Job seekers — especially those without degrees or at early career stages — shouldn&apos;t pay to prove their worth. The free plan is permanent, not a trial. Pro is for people who have found Proofolio genuinely useful and want more horsepower. We&apos;ll never put your existing submissions behind a paywall or delete your profile for downgrading.
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        {[
                            {
                                ...
                                points: [
                                    "You want to see if Proofolio is worth it",
            ...
            <section className="border-t border-[#1a2540] py-20 bg-[#0d1424]">
                <div className="max-w-xl mx-auto px-6 text-center">
                    ...
                    <p className="text-xs text-slate-600 mt-5">
                        ...
                        <a href="mailto:hello@proofolio.io" className="text-slate-500 hover:text-slate-400 underline underline-offset-2">
                            hello@proofolio.io
                        </a>
                    </p>
                </div>
